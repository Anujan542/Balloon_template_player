    ...
    <>
      ...
      >
        <div className="balloon-g">
          <div className="balloon1" style={{ backgroundColor: color1 }}>
...
459 -799 789 -1298 870 -123 20 -569 20 -679 0z"
      ...
      >
        <div className="balloon-g">
          <div className="balloon1" style={{ backgroundColor: color2 }}>
            <div className="balloon-ref"></div>
            {/* <span className="top-c"></span>
            <span className="left-c"></span> */}
          </div>
...
459 -799 789 -1298 870 -123 20 -569 20 -679 0z"
      ...
      >
        <div className="balloon-g">
          <div className="balloon1" style={{ backgroundColor: "white" }}>
            <div className="balloon-ref"></div>
            {/* <span className="top-c"></span>
            <span className="left-c"></span> */}
          </div>
